# Borelli Capital MazyOS

Antes de produzir conteúdo, leia `_memoria/empresa.md`, `_memoria/preferencias.md`, `_memoria/estrategia.md` e `identidade/design-guide.md`.
